...
class CentralCorridor(Scene):
    ...
    def enter(self):
        print(dedent("""
            ...
            destroyed you entire crew. You are the last surviving
            member and your last mission is to get the neutron destruct
            bomb from the Weapon Armory, put it in the bridge, and
            blow the ship up after getting into an escape pod.

            You're running down the central corridor ro the Weapon
            Armory when a Gothon jumps out, red scaly skin, dark grimy
            teeth, and evil clown costume flowing around his hate
            filled body. He's block the door to the Armory and
        ...
        if action == "shoot":
            print(dedent("""
                Quick in the draw you yand out your blaster and fire
                it at the Gothon. His clown costume is flowing and
                moving around his body, wich throws off you aim.
                Your laser hits his costume but misses gim entirely.
                This completely ruins his brand new costume his mother
                bouth him, wich makes him fly into an insane rage
            ...
            print(dedent("""
                ...
                slide right as the Goton's blaster crank a laser
                past your head. In the middle of your artful dodge
                your foot slips and you bang your head in the metal
            ...
            print(dedent("""
                Luckly for you they made you learn Fothon insult in
                the academy. You tell the one Gothon joke you know:
                Lbhe zbgre vf fb sng, jura fur fvgf nebhaq gur ubhfr,
                fur fvgf nebhaq gur ubhfr. The Gothon stops, tries
                not to laugh, then busts out laughting and can't move.
                While he's laughing you run up and shoot him square in
                the head putting him down, then jump through then
                Weapon Armory door.
                """))
...
class LaserWeaponArmory(Scene):
    ...
    def enter(self):
        print(dedent("""
            ...
            There's a keypad lock in the box and you need the code to
            get the bomb dut. If you get the code wrong 10 times then
        ...
        if guess == code:
            ...
            print(dedent("""
                The clock buzzed one last time and then you hear a
...
class TheBridge(Scene):
        ...
        def enter(self):
            print(dedent("""
                ...
                arm and don't wont to set it off.
                """))
            ...
            if action == "throw the bomb":
                print(dedent("""
                    You point your blaster at the bomd ynder your anm around
                    the Gothons put their hands up and start to sweat.
                    You inch backward to the door, open it, and then
                    carefully place the bomb on the floor, pointing your
                    blaster at it. You then jump back through the door,
                    punch the clode button and blast the lock so the
...
class EscapePod(Scene):
    ...
    def enter(self):
        print(dedent("""
            You rush thtough the ship desperately trying to make it to
            the escape pod before the whole ship explode. It seems
            like hardly any Gothons are on the ship, so your run is
            clear of interference. You get to the chamber with them
